...
1. The Magical Sorting Hat:
   ...
   Answer: solved easy array concept 

2. The Double Trouble:
   You are tasked with writing a function that doubles each element in an array. However, there's a catch: if the array contains consecutive duplicate elements, only double one of them.
   Answer:  solvable take an array then take individual element from the orginal array and swuare and push it to the new array beofre pushin justcheck if it exits or not in the new array if not push else continue

3. The Mirror Mirror:
   Imagine you have a string, and you need to create a new string that is a mirror image of the original. Write a function that appends the reversed version of the original string to itself.
   Answer: solved reverse and concat to other string 
